...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'error.modelNotFoundHint': '请到「设置 → API 提供商」检查当前 Provider 的「模型映射」是否填了上游 API 的真实模型 ID（如 claude-3-5-sonnet-latest），而不是显示别名。',
    ...
    'provider.modelMappingsHint': '填写上游 API 的真实模型 ID（如 claude-3-5-sonnet-latest），至少填一个用于测试连接',
    'provider.opusModel': 'DeepseekV4Pro',
    'provider.sonnetModel': 'DeepseekV4Flash',
    'provider.haikuModel': 'DeepseekV4Flash',
    'provider.opusPlaceholder': '如 claude-3-opus-latest',
    'provider.sonnetPlaceholder': '如 claude-3-5-sonnet-latest',
    'provider.haikuPlaceholder': '如 claude-3-5-haiku-latest',
    ...
    'provider.importCCSwitch': '同步 cc-switch 配置',
    'provider.ccSwitchSyncSuccess': '同步成功',
    'provider.ccSwitchSyncError': '同步失败',
    'provider.ccSwitchNotFound': '未找到 cc-switch 配置',
  ...
  en: {
    ...
    'error.modelNotFoundHint': 'Open Settings → API Provider and verify the model mapping uses the upstream API\'s real model ID (e.g. claude-3-5-sonnet-latest), not the display label.',
    ...
    'provider.modelMappingsHint': 'Enter the upstream API model ID (e.g. claude-3-5-sonnet-latest). At least one is required for connection test.',
    'provider.opusModel': 'DeepseekV4Pro',
    'provider.sonnetModel': 'DeepseekV4Flash',
    'provider.haikuModel': 'DeepseekV4Flash',
    'provider.opusPlaceholder': 'e.g. claude-3-opus-latest',
    'provider.sonnetPlaceholder': 'e.g. claude-3-5-sonnet-latest',
    'provider.haikuPlaceholder': 'e.g. claude-3-5-haiku-latest',
    'provider.modelIdPlaceholder': 'Model ID',
    ...
    'provider.importCCSwitch': 'Sync cc-switch Config',
    'provider.ccSwitchSyncSuccess': 'Sync successful',
    'provider.ccSwitchSyncError': 'Sync failed',
    'provider.ccSwitchNotFound': 'cc-switch config not found',
